...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a className="text-lg" href="/course">
          Releases
        </a>
      </li>
      <li>
  ...
  return (
    <>
      <div
        className={`w-full container md:px-20 px-4 fixed top-0 left-0 right-0 z-50 text-xl  ${
          sticky
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <div className="mr-auto flex items-center lg:mr-0 lg:pr-4">
              <Link
                to="/"
                className="text-2xl font-bold cursor-pointer dark:text-white mr-4 md:mr-8"
              >
                BookBuzz
              </Link>
            </div>
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1 font-b">{navItems}</ul>
            </div>
